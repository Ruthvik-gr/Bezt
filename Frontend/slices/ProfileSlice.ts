...
export const getUserProfile = createAsyncThunk('profile/getUserProfile', 
    ...
    const response = await fetch(`http://localhost:4000/profile/get-user-profile/${id}`, {
        method:"GET",
        headers:{
...
export const createProfile = createAsyncThunk('profile/createProfile', 
    ...
    const response = await fetch('http://localhost:4000/profile/create-user-profile', {
        method:"POST",
        headers:{
            "Content-Type":"application/json"
        },
...
export const editUserProfile = createAsyncThunk('profile/editUserProfile', 
    ...
    const response = await fetch(`http://localhost:4000/profile/update-user-profile/${userId}`, {
        method:"PATCH",
        headers:{
            "Content-Type":"application/json"
        },
...
export const deleteUserProfile = createAsyncThunk('profile/deleteUserProfile', 
    ...
    const response = await fetch(`http://localhost:4000m/profile/delete-user-profile/${id}`, {
        method:"DELETE",
        headers:{
            "Content-Type":"application/json"
        }
